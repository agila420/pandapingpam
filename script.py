...
def story():
    ...
    templates = {
                  1 : (
                       ...
                       'there are nurses here who have {color} {part_of_body}. If someone wants to come into my room I told them that they have to {verb} I’ve decorated my room with {number2} {noun2}\n'
